...
func _do(doer: Monster, source: Object, game_state: GameState, is_critical: bool):
	...
	var crit_coeffecient = critical_hit_damage_coefficient if is_critical else 1
	
	var amt = base_damage * type_advantage_coefficient * stat_diff_coefficient * crit_coeffecient	
